...
export default function VerificationCard() {
  return (
    ...
    >
      <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-amber-400/15">
      ...
      <div className="min-w-0">
        ...
        <div className="text-[11px] font-semibold text-amber-400">Help is ready</div>
      </div>
    </motion.div>
  );
}
