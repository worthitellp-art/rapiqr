...
export const SERVICE_TYPES: ServiceTypeMeta[] = [
  { slug: "ambulance", label: "Ambulance", legacy: "Ambulance", cta: "Coming Soon" },
  { slug: "towing", label: "Towing", legacy: "Towing", cta: "Coming Soon" },
  { slug: "mechanic", label: "Mechanic", legacy: "Mechanic", cta: "Coming Soon" },
  { slug: "flat_tire", label: "Flat Tire", legacy: "Flat Tire", cta: "Coming Soon" },
  { slug: "battery", label: "Battery", legacy: "Battery", cta: "Coming Soon" },
  { slug: "fuel", label: "Fuel", legacy: "Fuel", cta: "Coming Soon" },
  { slug: "parking", label: "Parking", legacy: "Parking", cta: "Coming Soon" },
  { slug: "police", label: "Police", legacy: "Police", cta: "Coming Soon" },
  { slug: "theft", label: "Theft", legacy: "Theft", cta: "Coming Soon" },
  { slug: "headlights", label: "Headlights", legacy: "Headlights", cta: "Coming Soon" },
  { slug: "family", label: "Family", legacy: "Family", cta: "Coming Soon" },
  { slug: "veterinarian", label: "Veterinarian", legacy: null, cta: "Coming Soon" },
  { slug: "plumber", label: "Plumber", legacy: null, cta: "Coming Soon" },
  { slug: "electrician", label: "Electrician", legacy: null, cta: "Coming Soon" },
  { slug: "locksmith", label: "Locksmith", legacy: null, cta: "Coming Soon" },
  { slug: "lift_technician", label: "Lift Technician", legacy: null, cta: "Coming Soon" },
  { slug: "courier", label: "Courier", legacy: null, cta: "Coming Soon" },
  { slug: "lost_found", label: "Lost & Found", legacy: null, cta: "Coming Soon" },
  { slug: "security", label: "Security", legacy: null, cta: "Coming Soon" },
  { slug: "support", label: "Support", legacy: null, cta: "Coming Soon" },
];
